...
namespace
{
	inline void ForEachInvEntryImpl(TESObjectREFR* a_objRef, ext::function_view<bool(InventoryEntryData*)> a_fn)
	{
...
inline void ForEachInvEntry(TESObjectREFR* a_objRef, ext::function_view<bool(InventoryEntryData*)> a_fn)
{
